...
def merge_featureCounts(out_file,input_files):
    
    logger = logging.getLogger(__name__)
    logger.addHandler(logging.StreamHandler())
    logger.setLevel(logging.INFO)

    input_files = glob.glob("*.count")
    ...
    for input_file in input_files:
        ...
        sample_name= sample_name.replace("_subs_Aligned.sortedByCoord.out.bam_uniquev5.count","")
...
if __name__ == "__main__":
    ...
    merge_featureCounts(args.out_file, args.input_files)